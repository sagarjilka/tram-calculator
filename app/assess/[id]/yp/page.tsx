      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-10 max-w-md w-full text-center">
          ...
          <p className="text-gray-500 text-sm">
            ...
            Your clinician will receive the full report once everyone has completed their questionnaire.
          </p>
        </div>
      </main>
    )
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 py-8">
      <div className="max-w-3xl mx-auto px-4 mb-4">
        <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 text-sm text-blue-800">
          <strong>For the young person:</strong> Your clinician has asked you to complete this short questionnaire about how you have been feeling. Your answers will be kept confidential and used to support your care.
        </div>
      </div>
      <QuestionnaireForm
        respondent="yp"
